...
class MopsSensors {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('external_voltage')) {
        this.external_voltage = initObj.external_voltage
      }
      else {
        this.external_voltage = 0.0;
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = _serializer.float64(obj.position0, buffer, bufferOffset);
    ...
    // Serialize message field [external_voltage]
    bufferOffset = _serializer.float64(obj.external_voltage, buffer, bufferOffset);
    // Serialize message field [digital_inputs]
    bufferOffset = _serializer.uint8(obj.digital_inputs, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new MopsSensors(null);
    // Deserialize message field [header]
    data.header = std_msgs.msg.Header.deserialize(buffer, bufferOffset);
    // Deserialize message field [position0]
    data.position0 = _deserializer.float64(buffer, bufferOffset);
    ...
    // Deserialize message field [external_voltage]
    data.external_voltage = _deserializer.float64(buffer, bufferOffset);
    // Deserialize message field [digital_inputs]
    data.digital_inputs = _deserializer.uint8(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new MopsSensors(null);
    ...
    if (msg.external_voltage !== undefined) {
      resolved.external_voltage = msg.external_voltage;
    }
    else {
      resolved.external_voltage = 0.0
    }
