...
nc = 60;                       % size of controller training set
...
policy.fcn = @(policy,m,s)conCat(@congp,@gSat,policy,m,s);% controller 
                                                          % representation
policy.maxU = 3.0;                                        % max. amplitude of 
                                                          % torque
...
opt.MFEPLS = 60;                         % max. number of function evaluations
                                         % per line search
