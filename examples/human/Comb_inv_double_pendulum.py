...
if __name__=='__main__':
    ...
    if input("Give demonstration or not (y/n)\n") == 'y':
        ...
        if os.path.exists('./examples/human/training_data_invd_X.npy') & os.path.exists('./examples/human/training_data_invd_Y.npy') \
        & os.path.exists('./examples/human/training_data_invd_Yc.npy') & os.path.exists('./examples/human/training_data_invd_Xc.npy'):
            Xc = np.load('./examples/human/training_data_invd_Xc.npy')
            Yc = np.load('./examples/human/training_data_invd_Yc.npy')
            X = np.load('./examples/human/training_data_invd_X.npy')
            Y = np.load('./examples/human/training_data_invd_Y.npy')
        else:
            raise Exception('Please give demonstration')

    np.save('./examples/human/training_data_invd_X.npy', X)
    np.save('./examples/human/training_data_invd_Y.npy', Y)
    np.save('./examples/human/training_data_invd_Xc.npy', Xc)
    np.save('./examples/human/training_data_invd_Yc.npy', Yc)
